    ...
    <div class="row g-5 g-lg-10">
        <div class="col-xl-12 mb-5 mb-xl-10">
            <div class="card h-xl-100">
                ...
                <form action="{{ route('home.update', $homeConfig->id) }}" method="post">
                    @csrf
                    @method('PUT')
                    <div class="mb-3 px-3">
                    ...
                    <div class="mb-3 px-3">
                        ...
                        <textarea name="about_description" class="form-control" rows="5" require>{{ $homeConfig->about_description }}</textarea>
                    </div>
                    <div class="mb-3 px-3">
                        <label for="about_image" class="form-label">About Image</label>
                        <input type="text" class="form-control" name="about_image" require value="{{ $homeConfig->about_image }}">
                    </div>
                    <div class="mb-3 px-3">
                        <label for="bg_image" class="form-label">Background Image</label>
                        <input type="text" class="form-control" name="bg_image" require value="{{ $homeConfig->bg_image }}">
                    </div>
                    <div class="mb-3 px-3">
